...
exports.rateLimiter = exports.apiRateLimit = exports.authRateLimit = exports.strictRateLimit = exports.generalRateLimit = void 0;
class RateLimiter {
    constructor() {
...
exports.generalRateLimit = rateLimiter.middleware({
    windowMs: 15 * 60 * 1000, // 15 минут
    max: 100, // 100 запросов за 15 минут
    message: 'Too many requests from this IP, please try again later'
});
exports.strictRateLimit = rateLimiter.middleware({
    windowMs: 15 * 60 * 1000, // 15 минут
    max: 20, // 20 запросов за 15 минут
    message: 'Rate limit exceeded for this endpoint'
});
exports.authRateLimit = rateLimiter.middleware({
    windowMs: 15 * 60 * 1000, // 15 минут
    max: 5, // 5 попыток входа за 15 минут
    message: 'Too many authentication attempts, please try again later'
});
exports.apiRateLimit = rateLimiter.middleware({
