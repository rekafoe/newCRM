...
class OptimizedQueries {
    ...
    static async getOrdersPaginated(limit = 50, offset = 0, filters = {}) {
    ...
    static async getOrdersStats(dateFrom, dateTo) {
        const db = await (0, database_1.getDb)();
        return await db.get(`
      SELECT 
    ...
    static async getMaterialConsumptionReport(dateFrom, dateTo) {
        const db = await (0, database_1.getDb)();
        return await db.all(`
      SELECT 
    ...
    static async searchOrders(query, limit = 20) {
        const db = await (0, database_1.getDb)();
        return await db.all(`
      SELECT 
        o.id,
