...
class UserNotificationController {
    ...
    static async getAllUsers(req, res) {
        try {
            const users = await userNotificationService_1.UserNotificationService.getAllUsers();
            res.json({
                success: true,
                data: users
            });
    ...
    static async getUsersByRole(req, res) {
        try {
            ...
            const users = await userNotificationService_1.UserNotificationService.getUsersByRole(role);
            res.json({
                success: true,
                data: users
            });
    ...
    static async sendToUser(req, res) {
        try {
            ...
            const success = await userNotificationService_1.UserNotificationService.sendToUser(parseInt(userId), notification);
            if (success) {
                res.json({
                    success: true,
    ...
    static async sendToRole(req, res) {
        try {
            ...
            const sentCount = await userNotificationService_1.UserNotificationService.sendToRole(role, notification);
            res.json({
                success: true,
    ...
    static async sendToAllUsers(req, res) {
        try {
            ...
            const sentCount = await userNotificationService_1.UserNotificationService.sendToAllUsers(notification);
            res.json({
                success: true,
     ...
     */
    static async sendLowStockAlert(req, res) {
        try {
            const { materialName, currentQuantity, minStock, supplierName } = req.body;
            const sentCount = await userNotificationService_1.UserNotificationService.sendLowStockAlert(materialName, currentQuantity, minStock, supplierName);
            res.json({
                success: true,
     ...
     */
    static async sendNewOrderAlert(req, res) {
        try {
            const { orderId, customerName, totalAmount } = req.body;
            const sentCount = await userNotificationService_1.UserNotificationService.sendNewOrderAlert(orderId, customerName, totalAmount);
            res.json({
                success: true,
     ...
     */
    static async sendSystemAlert(req, res) {
        try {
            const { title, message, priority } = req.body;
            const sentCount = await userNotificationService_1.UserNotificationService.sendSystemAlert(title, message, priority);
            res.json({
                success: true,
     ...
     */
    static async updateUserTelegramChatId(req, res) {
        try {
            const { userId } = req.params;
            const { chatId } = req.body;
            const success = await userNotificationService_1.UserNotificationService.updateUserTelegramChatId(parseInt(userId), chatId);
            if (success) {
                res.json({
                    success: true,
     ...
     */
    static async getBotUsers(req, res) {
        try {
            const users = await userNotificationService_1.UserNotificationService.getBotUsers();
            res.json({
                success: true,
                data: users
            });
     ...
     */
    static async sendTestMessageToBotUsers(req, res) {
        try {
            const sentCount = await userNotificationService_1.UserNotificationService.sendTestMessageToBotUsers();
            res.json({
                success: true,
     ...
     */
    static async sendLowStockToBotUsers(req, res) {
        try {
            const { materialName, currentQuantity, minStock, supplierName } = req.body;
            const botUsers = await userNotificationService_1.UserNotificationService.getBotUsers();
            let sentCount = 0;
